package com.fluxninja.envoy.service.auth.v3;
...
public final class AuthorizationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.fluxninja.envoy.service.auth.v3.CheckRequest,
      com.fluxninja.envoy.service.auth.v3.CheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = com.fluxninja.envoy.service.auth.v3.CheckRequest.class,
      responseType = com.fluxninja.envoy.service.auth.v3.CheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.fluxninja.envoy.service.auth.v3.CheckRequest,
      com.fluxninja.envoy.service.auth.v3.CheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<com.fluxninja.envoy.service.auth.v3.CheckRequest, com.fluxninja.envoy.service.auth.v3.CheckResponse> getCheckMethod;
      ...
      synchronized (AuthorizationGrpc.class) {
        if ((getCheckMethod = AuthorizationGrpc.getCheckMethod) == null) {
          AuthorizationGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<com.fluxninja.envoy.service.auth.v3.CheckRequest, com.fluxninja.envoy.service.auth.v3.CheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fluxninja.envoy.service.auth.v3.CheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fluxninja.envoy.service.auth.v3.CheckResponse.getDefaultInstance()))
  ...
  public static abstract class AuthorizationImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void check(com.fluxninja.envoy.service.auth.v3.CheckRequest request,
        io.grpc.stub.StreamObserver<com.fluxninja.envoy.service.auth.v3.CheckResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.fluxninja.envoy.service.auth.v3.CheckRequest,
                com.fluxninja.envoy.service.auth.v3.CheckResponse>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class AuthorizationBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthorizationBlockingStub> {
     ...
     * </pre>
     */
    public com.fluxninja.envoy.service.auth.v3.CheckResponse check(com.fluxninja.envoy.service.auth.v3.CheckRequest request) {
  ...
  public static final class AuthorizationFutureStub extends io.grpc.stub.AbstractFutureStub<AuthorizationFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.fluxninja.envoy.service.auth.v3.CheckResponse> check(
        com.fluxninja.envoy.service.auth.v3.CheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((com.fluxninja.envoy.service.auth.v3.CheckRequest) request,
              (io.grpc.stub.StreamObserver<com.fluxninja.envoy.service.auth.v3.CheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthorizationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.fluxninja.envoy.service.auth.v3.EnvoyAuthzProto.getDescriptor();
    }
