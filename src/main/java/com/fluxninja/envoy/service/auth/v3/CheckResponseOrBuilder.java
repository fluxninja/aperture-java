...
public interface CheckResponseOrBuilder extends
   ...
   * @return The status.
   */
  com.fluxninja.google.rpc.Status getStatus();
  /**
   * <pre>
   * Status ``OK`` allows the request. Any other status indicates the request should be denied, and
   * for HTTP filter, if not overridden by :ref:`denied HTTP response status &lt;envoy_v3_api_field_service.auth.v3.DeniedHttpResponse.status&gt;`
   ...
   * <code>.google.rpc.Status status = 1 [json_name = "status"];</code>
   */
  com.fluxninja.google.rpc.StatusOrBuilder getStatusOrBuilder();
   ...
   */
  com.fluxninja.envoy.service.auth.v3.DeniedHttpResponse getDeniedResponse();
  /**
   * <pre>
   * Supplies http attributes for a denied response.
   * </pre>
   ...
   * <code>.envoy.service.auth.v3.DeniedHttpResponse denied_response = 2 [json_name = "deniedResponse"];</code>
   */
  com.fluxninja.envoy.service.auth.v3.DeniedHttpResponseOrBuilder getDeniedResponseOrBuilder();
   ...
   */
  com.fluxninja.envoy.service.auth.v3.OkHttpResponse getOkResponse();
  /**
   * <pre>
   * Supplies http attributes for an ok response.
   * </pre>
   ...
   * <code>.envoy.service.auth.v3.OkHttpResponse ok_response = 3 [json_name = "okResponse"];</code>
   */
  com.fluxninja.envoy.service.auth.v3.OkHttpResponseOrBuilder getOkResponseOrBuilder();
  ...
  public com.fluxninja.envoy.service.auth.v3.CheckResponse.HttpResponseCase getHttpResponseCase();
}
